...
path = basepath + '/Zee/v8.1/r0'

command = """maestro.py task create \
  -v {PATH} \
  -t user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM1.bkg.VProbes_EGAM7.GRL_v97.v8.1_et{ET}_eta{ETA}.r0 \
  -c user.jodafons.job_config.Zee_v8.1.n2to5.10sorts.5inits.r0 \
  -d user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM1.bkg.VProbes_EGAM7.GRL_v97_et{ET}_eta{ETA}.npz \
  --sd "{REF}" \
  --exec "run_tuning.py -c %IN -d %DATA -r %REF -v %OUT -b zee -t v8.1 -p r0" \
  --queue "gpu" """
